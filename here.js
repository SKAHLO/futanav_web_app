...
function calculateRouteFromAtoB(platform, a, b) {
  ...
  var router = platform.getRoutingService(null, 8),
      routeRequestParams = {
        routingMode: 'fast',
        transportMode: 'car',
        origin: `${a.lat},${a.lng}`, // Brandenburg Gate
        destination: `${b.lat},${b.lng}`, // Friedrichstraße Railway Station
...
var platform = new H.service.Platform({
  apikey: "Md3Wz1GtjbwFht6Ztbb_n_6BJ5Sj4AXjy18nFFuaJmQ"
});
...
function addRouteShapeToMap(route) {
  route.sections.forEach((section) => {
    ...
    boundbox = polyline.getBoundingBox()
    /*boundbox = new H.geo.Rect(
                boundbox.Ri.lat-0.000001, boundbox.Ri.lng-0.000001,
                boundbox.ll.lat+0.000001, boundbox.ll.lng+0.000001
    );*/
